          ...
          <Menubar.Root className=" text-primary-dark py-2 px-4 font-semibold text-lg ">
            <Menubar.Menu>
              <Menubar.Trigger className="relative cursor-pointer group">
                ...
                <span
                  className="absolute inset-x-0 bottom-0 h-0.5 -mx-2 bg-gradient-to-r from-sky-950
                 to-slate-300 transform scale-x-0 transition-all duration-300 group-hover:scale-x-100"
                ></span>
              </Menubar.Trigger>
              <Menubar.Portal>
                <Menubar.Content
